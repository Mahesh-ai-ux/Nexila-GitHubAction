...
//nexila changes - pending fee students
import PendingFeeStudents from "../feature-module/Pages/crm-module/projects/PendingFeeStudents";
...
export const publicRoutes = [
  ...
  // routes.js or wherever you define
  {
    id: "94",
    path: "/leads-details/:id",   // ✅ IMPORTANT //nexila changes
  ...
  {
    id: "200",
    path: "/students/pending-fee",
    element: <PendingFeeStudents />,
    route: Route,
    meta_title: "Pending Fee Students",
  },
];
