...
export const Categorys = [
  { value: "Select", label: "Select" },
  { value: "Graduate - Job Seeker", label: "Graduate - Job Seeker" },
  { value: "Working Professional - Technical", label: "Working Professional - Technical" },
  { value: "Working Professional - Non-Technical", label: "Working Professional - Non-Technical" },
  { value: "College Student - Final Year", label: "College Student - Final Year" },
  { value: "College Student - (1st - Pre Final Year)", label: "College Student - (1st - Pre Final Year)" },
];
//nexila changes 27/04/2026
...
export const Industry = [
  { value: 'Choose', label: 'Choose' },
  { value: 'Full Stack - Python', label: 'Full Stack - Python' },
  { value: 'Full Stack - Java', label: 'Full Stack - Java' },
  { value: 'Full Stack - MERN', label: 'Full Stack - MERN' },
  { value: 'Full Stack - MEAN', label: 'Full Stack - MEAN' },
  ...
  { value: 'Big Data', label: 'Artificial Intelligence' },
  { value: 'Tableau', label: 'Tableau' },
  { value: 'DevOps', label: 'DevOps' },
  { value: 'Software Testing', label: 'Software Testing' },
  { value: 'Cloud Computing - Azure', label: 'Cloud Computing - Azure' },
  { value: 'Cloud Computing - GCP', label: 'Cloud Computing - GCP' },
...
export const Leadstatus = [
  ...
  { value: 'DND/RNR', label: 'DND/RNR' },
  { value: 'Drop-Out', label: 'Drop-Out' },
  { value: 'Demo Follow-Up 1', label: 'Demo Follow-Up 1' },
  { value: 'Drop-Out Demo', label: 'Drop-Out Demo' },
  { value: 'Student', label: 'Student' },
];
export const Assign_From = [
  { value: 'Choose', label: 'Choose' },
  { value: 'Ranjana', label: 'Ranjana' },
